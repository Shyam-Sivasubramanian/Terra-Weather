...
public:
    ...
    glm::vec3 skyColor(const glm::vec3& rayDir, float time = 0.0f) {
        ...
        atmosphereColor += mieTerm * glm::vec3(glm::vec3(AtmosphereConstants::mieCoeff * turbidity));
    ...
    glm::vec3 skyColorFull(const glm::vec3& rayDir, const glm::vec3& sunDir, float time = 0.0f) {
        ...
        glm::vec3 coefficients[2] = { AtmosphereConstants::rayleighCoeff, glm::vec3(glm::vec3(AtmosphereConstants::mieCoeff * turbidity)) };
